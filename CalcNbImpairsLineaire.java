/**
 * Implémentation de l'interface {@code Calculateur} pour calculer le nombre d'impairs dans une séquence donnée,
 * en utilisant une approche linéaire.
 */
public class CalcNbImpairsLineaire implements Calculateur {
    /**
